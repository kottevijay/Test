...
public class LoginAutomation2 
{
	...
	{
	  Assert.assertEquals(loginPage.loginSuccess(), expected); 
	...
	{
	  Assert.assertEquals(loginPage.loginError(), true);
	...
	{
		Assert.assertEquals(loginPage.errorText(), expectedErrText);
